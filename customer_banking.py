...
def main():
    ...
    savings_maturity=int(input("How many months will it stay in this account?\n "))
    ...
    print(f"""After {savings_maturity} months,
The interest earned will be ${s_interest_earned:,.2f}.
The total balance will be ${updated_savings_balance:,.2f} in the account.""")
    ...
    cd_maturity=int(input("How many months will it stay in this account?\n "))
    ...
    print(f"""After {cd_maturity} months,
The interest earned will be ${c_interest_earned:,.2f}.
The total balance will be ${updated_cd_balance:,.2f} in the account.""")
